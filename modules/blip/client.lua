...
function B1.registerBlip(coords, label, sprite, colour, scale, display)
...
function B1.registerJobBlip(job, coords, label, sprite, colour, scale, display)
end

function B1.registerGangBlip(gang, coords, label, sprite, colour, scale, display)
end
